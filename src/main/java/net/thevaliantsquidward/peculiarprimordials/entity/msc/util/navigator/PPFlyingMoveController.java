package net.thevaliantsquidward.peculiarprimordials.entity.msc.util.navigator;
...
public class PPFlyingMoveController extends MoveControl {
    ...
    public PPFlyingMoveController(Mob flier, float speedGeneral, boolean shouldLookAtTarget, boolean needsYSupport) {
        super(flier);
    ...
    public PPFlyingMoveController(Mob flier, float speedGeneral, boolean shouldLookAtTarget) {
        this(flier, speedGeneral, shouldLookAtTarget, false);
    }

    public PPFlyingMoveController(Mob flier, float speedGeneral) {
