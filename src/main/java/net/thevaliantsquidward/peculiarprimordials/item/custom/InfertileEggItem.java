...
public class InfertileEggItem extends Item {
    public InfertileEggItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            InfertileGiganhingaEggEntity egg = new InfertileGiganhingaEggEntity(pLevel, pPlayer);
